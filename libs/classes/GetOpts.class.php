...
class GetOpts
{
    ...
    public function is_defined($option)
    {
    ...
    protected function _get_opt($opts, $args)
    {
        ...
        while(($arg = array_shift($args)) !== null)
        {
            ...
            else if ($arg[0] == "-")
            {
                ...
                {
                    // found a long arg
                    // the short arg is referenced by using the first character
                    //from the long arg.

                    // make sure an idiot doesn't pass in an empty '--', trying 
                    //to break the code >:[ ... I don't think so!
